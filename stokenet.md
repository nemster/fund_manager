# Stokenet deployment of version 0.2
...
Ociswap registry badge: `resource_tdx_2_1nfkhdgruseldvkrlgu9j3vp7uyh98t6arhfl7ugcrj6pzuraynpnfs`  
...
CALL_METHOD
    ...
    None
    None
    Some(Address("account_tdx_2_129y9wu3vugaeasnprxjlrqy3tpmr7hpurrmapmyqhsr26ehhrh22e2"))
;
```
...
;
CALL_FUNCTION
    Address("package_tdx_2_1p4nhdquv2wc65nla2jxqnhemut7jng044s7madjcvdwmslp2cp5p7l")
    "WeftWrapper"
    "new"
    Address("resource_tdx_2_1tknxxxxxxxxxradxrdxxxxxxxxx009923554798xxxxxxxxxtfd2jc")
...
### Create an OciswapLpPool2Wrapper for the WEFT/XRD pool and pass it the ownership of an account
```
CALL_METHOD
    Address("account_tdx_2_128vequruas26gq3we8u7wsqdrswtydh357x98444fdg3agfy5m0y9d")
    "withdraw_non_fungibles"
...
;
CALL_FUNCTION
    Address("package_tdx_2_1p4wtkvhhpp8tdqm08k9sxh5grk5zlkrhvl6r63nscddvns2d69g3vx")
    "OciswapLpPool2Wrapper"
    "new"
    Address("resource_tdx_2_1t4pttehu02el4jrqdua56rgt8057hx2fnzm63yv6wt5p5nj6ant0kq")
    Address("resource_tdx_2_1tknxxxxxxxxxradxrdxxxxxxxxx009923554798xxxxxxxxxtfd2jc")
...
### Instantiate a SurgeWrapper component and pass it the ownership of an account
```
CALL_METHOD
    Address("account_tdx_2_128vequruas26gq3we8u7wsqdrswtydh357x98444fdg3agfy5m0y9d")
    "withdraw_non_fungibles"
...
;
CALL_FUNCTION
    Address("package_tdx_2_1pk2yn9ql6rnldlw99z3a5975ly0ngncdeym0zx0djvay5f58pa2ys6")
    "SurgeWrapper" 
    "new"
    Address("resource_tdx_2_1t50uv6v747hw4d2rneh7elfppz8jf7hzjxp2q260weh76cc9qzk85r")
...
### Instantiate a RootFinanceWrapper component and pass it the ownership of an account
```
CALL_METHOD
    Address("account_tdx_2_128vequruas26gq3we8u7wsqdrswtydh357x98444fdg3agfy5m0y9d")
    "withdraw_non_fungibles"
...
;
CALL_FUNCTION
    Address("package_tdx_2_1pk6vjpp63clc7ylc5nwejew69dw3fg3j7h0mt6yymtrkcaex48gdc2")
    "RootFinanceWrapper"
    "new"
    Address("resource_tdx_2_1thr3zv65sm5w3jvaz4murfdfyl49u3skr20rlssgjfngmj7ax7n86j")
...
### Instantiate a FluxWrapper component and give it the control over an account
```
CALL_METHOD
    Address("account_tdx_2_128vequruas26gq3we8u7wsqdrswtydh357x98444fdg3agfy5m0y9d")
    "withdraw_non_fungibles" 
...
;
CALL_FUNCTION
    Address("package_tdx_2_1pkhdgxgxcxelenel07ex7hgqe8834ftwtl883na60t36lxc9unxstn")
    "FluxWrapper"
    "new"
    Address("resource_tdx_2_1thc6avtsk0f2d4mgp4rca76nw6753yz638e0qaszzhqy6e469pcca7")
    Address("resource_tdx_2_1t59ygltctweq749ucj702a9d6ap8pv60pxjyu05048vfzdnq9fsc2c")
